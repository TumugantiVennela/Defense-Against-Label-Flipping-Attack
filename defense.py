...
MODELS_PATH = "C:/Users/TumugantiVennela/aafl/default_models"
EXP_INFO_PATH = "C:/Users/TumugantiVennela/aafl/logs/3000.log"
# img = Image.open("C:/Users/TumugantiVennela/aafl/defense_result.png")
...
POISONED_WORKER_IDS = ['38','34','6','11','44']
...
if __name__ == '__main__':
    ...
    for epoch in EPOCHS:
        ...
        start_model_files = get_model_files_for_suffix(start_model_files, args.get_epoch_save_start_suffix())
        if not start_model_files:
            # print(f"No files found with suffix {args.get_epoch_save_start_suffix()}")
            continue  # skip to the next epoch
        start_model_file = start_model_files[0]

        start_model_file = os.path.join(''.join(MODELS_PATH), start_model_file)
        ...
        if not end_model_files:
            # print(f"No files found with suffix {args.get_epoch_save_end_suffix()} for epoch {epoch}")
            continue  # skip to the next epoch
